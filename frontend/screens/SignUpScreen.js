...
const SignInScreen = ({ navigation }) => {
    ...
    const handleSignUp = async (un, pw) => {
        if (await trySignup(un, pw)) {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.button}>
                    <TouchableOpacity style={[styles.signIn, { backgroundColor: '#528ae6' }]} onPress={() => { handleSignUp(data.username, data.password) }}>
