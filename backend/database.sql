...
(
	...
	CONSTRAINT PK_TASKACCESSIBILITY
	PRIMARY KEY (MEM_POS)
)
...
ADD CONSTRAINT FK_PROJECT_MEMBER
	...
	CONSTRAINT FK_PROJECT_ACCESSIBILITY
	FOREIGN KEY (MEM_POS)
	REFERENCES PROJECT_ACCESSIBILITY,
	CONSTRAINT FK_TASK_ACCESSIBILITY
	FOREIGN KEY (MEM_POS)
	REFERENCES TASK_ACCESSIBILITY
